(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue3-smooth-scrollbar"] = factory(require("vue"));
	else
		root["vue3-smooth-scrollbar"] = factory(root["Vue"]);
...
function checkNumber(value = 0, defValue = 0) {
  value = +value;
  return (0,lodash.isNaN)(value) ? defValue : value;
}
/**
 * @param {Number} limitY
...
function checkLoadCapability(limitY = 0, offsetY = 0, loadThreshold = 0) {
...
function getScrollState(scrollBar, axis = "", prop = "") {
  let state = (0,lodash.get)(scrollBar, prop, {});

  switch (axis) {
    case "x":
    case "y":
      return (0,lodash.get)(state, axis);
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-80.use[1]!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].use[0]!./node_modules/@vue/cli-service/node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./src/SmoothScrollbar.vue?vue&type=script&lang=js
...
/* harmony default export */ var SmoothScrollbarvue_type_script_lang_js = ({
  name: "c-scroll-view",
  props: {
    infiniteLoading: {
      type: Boolean,
  ...
  methods: {
    ...
    setLoaded() {
      ...
      this.$nextTick(() => {
        ...
        if (helpers.checkLoadCapability(limitY, offsetY, this.loadThreshold)) {
          this.emitLoad();
        }
      });
    },
  ...
  mounted() {
    this.$nextTick(() => {
      ...
      this.scrollBar = smooth_scrollbar.init(this.$refs.view, helpers.defaultsDeep(this.options, defaultOptions)); // Add infinite loading listener
      ...
      this.addListener(status => {
        ...
        let canLoad = helpers.checkLoadCapability(limit.y, offset.y, this.loadThreshold);
  ...
  render() {
    ...
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)("div", containerData, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)("div", {
...
;// CONCATENATED MODULE: ./src/SmoothScrollbar.vue?vue&type=script&lang=js
 
;// CONCATENATED MODULE: ./src/SmoothScrollbar.vue



/* harmony default export */ var src_SmoothScrollbar = (SmoothScrollbarvue_type_script_lang_js);
;// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = (src_SmoothScrollbar);
...
//# sourceMappingURL=vue3-smooth-scrollbar.umd.js.map